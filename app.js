...
// CORS configuration
app.use(cors({
  origin: process.env.CLIENT_URL || ["http://localhost:5173", "http://localhost:5174", "http://localhost:5175", "https://soil-management-backend-new.onrender.com"],
  credentials: true,
...
import machineCategoryRoutes from './routes/machineCategoryRoutes.js';
...
app.use('/api/machine-categories', machineCategoryRoutes);
